...
class KuntagmlLoader:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&Kunta GML Loader')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('KuntagmlLoader', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/KuntagmlLoader/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Load Kunta GML'),
            callback=self.run,
    ...
    def run_for_widget(self):
        ...
        if not self.pluginIsActive:
            ...
            if self.dockwidget == None:
                ...
                self.dockwidget = LoaderDockwidget(self.iface)
